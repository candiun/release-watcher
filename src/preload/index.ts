...
const api: ReleaseTrackerApi = {
  listSources: () => ipcRenderer.invoke('sources:list') as ReturnType<ReleaseTrackerApi['listSources']>,
  ...
  getSettings: () => ipcRenderer.invoke('settings:get') as ReturnType<ReleaseTrackerApi['getSettings']>,
  updateSettings: (settings: SettingsUpdate) =>
    ipcRenderer.invoke('settings:update', settings) as ReturnType<ReleaseTrackerApi['updateSettings']>
};
